...
#include "BaseCharacterVisuals.generated.h"
...
class ABaseCharacterVisuals : public ACharacter, public IAbilitySystemInterface
{
	GENERATED_BODY()

public:
	ABaseCharacterVisuals(const FObjectInitializer&);
